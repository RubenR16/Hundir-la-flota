...
public class PartidaFrame extends JFrame {
    ...
    private void inicializarInterfaz() {
        ...
        JPanel panelInfoEnemigo = new JPanel(new BorderLayout());
        ...
        panelInfoEnemigo.add(lblTurno, BorderLayout.NORTH);
        panelInfoEnemigo.add(lblDisparosRestantes, BorderLayout.SOUTH);
