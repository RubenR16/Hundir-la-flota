...
public class JuegoFrame extends JFrame {
	...
	public JuegoFrame() {
		...
		getContentPane().add(tableroPanel, BorderLayout.CENTER);   // Panel principal del tablero
		getContentPane().add(controlPanel, BorderLayout.EAST);     // Panel lateral de controles
